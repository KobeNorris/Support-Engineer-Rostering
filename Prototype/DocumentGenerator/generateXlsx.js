function createFormattingWorkbook() {
    ...
    var sheet = workbook.worksheets().add('Out Of Hours Support Claim Form');
    sheet.columns(0).setWidth(40, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(1).setWidth(155, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(2).setWidth(153, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(3).setWidth(76, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(4).setWidth(135, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(5).setWidth(153, $.ig.excel.WorksheetColumnWidthUnit.pixel);
    sheet.columns(6).setWidth(12, $.ig.excel.WorksheetColumnWidthUnit.pixel);
